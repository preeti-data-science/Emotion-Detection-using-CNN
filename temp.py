...
"""
import os
os.chdir("C:/Users/Innodatatics")

# Import necessary libraries for CNN and reshaping the data structres
import numpy as np
...
import pandas as pd
train = pd.read_csv("C:/Users/Innodatatics/Desktop/Machine Learning, AI & DL/ANN/train_sample (1).csv")
test = pd.read_csv("C:/Users/Innodatatics/Desktop/Machine Learning, AI & DL/ANN/test_sample (1).csv")
...
# giving the input to train the CNN mode
def design_mlp():
